...
namespace CovidServe.Controllers.fetchSort
{
    ...
    [ApiController]
    public class fetchSortedNewDeaths : ControllerBase
    {
        private readonly CountryService _countryService;

        public fetchSortedNewDeaths(CountryService countryService)
        {
        ...
        {
            return _countryService.GetSortedCount(parameters.Ascending, "newdeaths", parameters.Top, parameters.Year, parameters.Month, parameters.Day);
        }
    }
}
