...
namespace CovidServe.Controllers
{
    ...
    [ApiController]
    public class fetchSortedDeathCount : ControllerBase
    {
        private readonly CountryService _countryService;

        public fetchSortedDeathCount(CountryService countryService)
        {
        ...
        {
            return _countryService.GetSortedCount(parameters.Ascending, "deaths", parameters.Top, parameters.Year, parameters.Month, parameters.Day);
        }
    }
}
