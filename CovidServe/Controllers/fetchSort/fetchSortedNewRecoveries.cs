...
namespace CovidServe.Controllers.fetchSort
{
    ...
    [ApiController]
    public class fetchSortedNewRecoveries : ControllerBase
    {
        private readonly CountryService _countryService;

        public fetchSortedNewRecoveries(CountryService countryService)
        {
        ...
        {
            return _countryService.GetSortedCount(parameters.Ascending, "newrecoveries", parameters.Top, parameters.Year, parameters.Month, parameters.Day);
        }
    }
}
