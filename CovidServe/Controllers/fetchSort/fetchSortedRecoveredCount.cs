...
namespace CovidServe.Controllers
{
    ...
    [ApiController]
    public class fetchSortedRecoveredCount : ControllerBase
    {
        private readonly CountryService _countryService;

        public fetchSortedRecoveredCount(CountryService countryService)
        {
        ...
        {
            return _countryService.GetSortedCount(parameters.Ascending, "recovered", parameters.Top, parameters.Year, parameters.Month, parameters.Day);
        }
    }
}
