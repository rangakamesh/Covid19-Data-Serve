...
namespace CovidServe.Controllers
{
    ...
    [ApiController]
    public class fetchSortedActiveCount : ControllerBase
    {
        private readonly CountryService _countryService;

        public fetchSortedActiveCount(CountryService countryService)
        {
        ...
        {
            return _countryService.GetSortedCount(parameters.Ascending, "active", parameters.Top, parameters.Year, parameters.Month, parameters.Day);
        }
    }
}
