...
namespace CovidServe.Controllers.fetchField
{
    ...
    [ApiController]
    public class fetchCountryNewCases : ControllerBase
    {
        private readonly CountryService _countryService;

        public fetchCountryNewCases(CountryService countryService)
        {
        ...
        {
            return _countryService.GetCountryField(parameters.Ascending, "newcases", parameters.CountryName);
        }
    }
}
