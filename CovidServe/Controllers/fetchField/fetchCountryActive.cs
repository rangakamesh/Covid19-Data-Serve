...
namespace CovidServe.Controllers.fetchField
{
    ...
    [ApiController]
    public class fetchCountryActive : ControllerBase
    {
        private readonly CountryService _countryService;

        public fetchCountryActive(CountryService countryService)
        {
        ...
        {
            return _countryService.GetCountryField(parameters.Ascending, "active", parameters.CountryName);
        }
    }
}
