...
namespace CovidServe.Controllers
{
    ...
    [ApiController]
    public class fetchCountryOnDate : ControllerBase
    {
        private readonly CountryService _countryService;

        public fetchCountryOnDate(CountryService countryService)
        {
        ...
        {
            return _countryService.GetCountryOnDate(parameters.CountryName, parameters.Year, parameters.Month, parameters.Day);
        }
