...
namespace CovidServe.Controllers
{
    ...
    [ApiController]
    public class fetchTopActiveCount : ControllerBase
    {
        private readonly CountryService _countryService;

        public fetchTopActiveCount(CountryService countryService)
        {
        ...
        {
            return _countryService.GetTopCount("active", parameters.Top, parameters.Year, parameters.Month, parameters.Day);
        }
    }
}
