...
namespace CovidServe.Controllers
{
    ...
    [ApiController]
    public class fetchTopConfirmedCount : ControllerBase
    {
        private readonly CountryService _countryService;

        public fetchTopConfirmedCount(CountryService countryService)
        {
        ...
        {
            return _countryService.GetTopCount("confirmed", parameters.Top, parameters.Year, parameters.Month, parameters.Day);
        }
    }
}
