...
namespace CovidServe.Controllers
{
    ...
    [ApiController]
    public class fetchTopRecoveredCount : ControllerBase
    {
        private readonly CountryService _countryService;

        public fetchTopRecoveredCount(CountryService countryService)
        {
        ...
        {
            return _countryService.GetTopCount("recovered", parameters.Top, parameters.Year, parameters.Month, parameters.Day);
        }
    }
}
