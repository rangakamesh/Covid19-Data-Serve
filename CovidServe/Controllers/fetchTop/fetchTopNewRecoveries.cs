...
namespace CovidServe.Controllers.fetchTop
{
    ...
    [ApiController]
    public class fetchTopNewRecoveries : ControllerBase
    {
        private readonly CountryService _countryService;

        public fetchTopNewRecoveries(CountryService countryService)
        {
        ...
        {
            return _countryService.GetTopCount("newrecoveries", parameters.Top, parameters.Year, parameters.Month, parameters.Day);
        }
    }
}
